    ...
    if fold >= 0 :
        ...
        if fold < 30:
            if fold in [3, 7]:
                ...
                train_inputs = [inputs_question[i][train_idx] for i in range(2)]
                ...
                valid_inputs = [inputs_question[i][valid_idx] for i in range(2)]
                valid_inputs.append(feature_embeddings[valid_idx])
                valid_outputs = outputs_question[valid_idx]
                ...
                history = train_and_predict(model,
                                            ...
                                            loss_function='binary_crossentropy', fold=fold, Q=True)
